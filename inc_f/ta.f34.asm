;;bin_stat_by_ip_global();
	sub	ecx,ecx
    .lp:
	mov	esi,bin_stat_by_ip_global_buffer
	lodsd
	dec	eax
	imul	ebx,ecx,MAXL_BIN_STAT_BY_IP_GLOBAL
	add	esi,ebx
	    push ecx
		push	eax
	    	    call do_bin_stat_big
		pop	eax
	    pop ecx
	inc	ecx
	cmp	ecx,eax
...
do_bin_stat_big:
	...
	cmp	al,MAXPC_BIN_STAT_BY_IP_GLOBAL
	jz	.nex_1
	sub	al,(MAXPC_BIN_STAT_BY_IP_GLOBAL-1)
	jz	.next
	mov	eax,err_sPC
	call	write
	call	@exit	    
