;;bin_full_stat_by_ip_dev();
	sub	ecx,ecx
    .lp:
	mov	esi,bin_full_stat_by_ip_dev_buffer
	lodsd
	dec	eax
	imul	ebx,ecx,MAXL_BIN_FULL_STAT_BY_IP_DEV
	add	esi,ebx
	    push ecx
		push	eax
	    	    call do_bin_stat_fbid
		pop	eax
	    pop ecx
	inc	ecx
	cmp	ecx,eax
...
do_bin_stat_fbid:
	...
	cmp	al,MAXPC_BIN_FULL_STAT_BY_IP_DEV
	jz	.nex_1
	sub	al,(MAXPC_BIN_FULL_STAT_BY_IP_DEV-1)
	jz	.next	
	mov	eax,err_sPC
	call	write
	call	@exit	    
